...
possible violation, email [legal@genaptic.com](mailto:legal@genaptic.com).
Unconflicted administrators of the Genaptic GitHub organization serve as
Community Moderators for this Code of Conduct. Reports and related materials
must be accessible only to those unconflicted Community Moderators. Any
administrator named in, directly involved in, or otherwise conflicted regarding
a report must not access the report or related materials and must recuse
themselves from its review, investigation, decision-making, and enforcement.

If all Genaptic organization administrators are implicated, unavailable, or
otherwise conflicted, or if the primary channel cannot prevent an implicated
administrator from receiving or accessing the report, email
[jecs838@gmail.com](mailto:jecs838@gmail.com). The fallback recipient must keep
the report and related materials inaccessible to implicated administrators and
handle the report independently. Do not report possible violations in a public
GitHub issue.
...
Contract Kit customized the reporting and enforcement-administration details
for this adaptation.
